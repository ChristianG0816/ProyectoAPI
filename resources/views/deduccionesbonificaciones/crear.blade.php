...
<div class="row justify-content-center">
    <div class="col-md-8">
        <form action="{{ route('deduccionesbonificaciones.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="valor_pagar" class="form-control{{ $errors->has('valor_pagar') ? ' is-invalid' : '' }}">
                                @error('valor_pagar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="accion" class="form-control{{ $errors->has('accion') ? ' is-invalid' : '' }}">
                                @error('accion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_tipo_frecuencia" class="form-control{{ $errors->has('id_tipo_frecuencia') ? ' is-invalid' : '' }}">
                                    @foreach ($tiposFrecuencia as $tipoFrecuencia)
                                        <option value="{{ $tipoFrecuencia->id }}">{{ $tipoFrecuencia->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="observacion" class="form-control{{ $errors->has('observacion') ? ' is-invalid' : '' }}">
                                @error('observacion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-6 text-right">
                                <button type="submit" class="btn btn-info">Agregar Movimiento de Nómina</button>
